...
Uses the interative Hill Climbing algorithm in order to remove the last connection 
...
def hillclimb_last(connection_objects, station_objects, solution):
    ...
    for i, route in enumerate(copy_state.lining):  
        ...
        while next is False: 
            ...
            # deletes the last connection from the route
            del imp_route[-1]
